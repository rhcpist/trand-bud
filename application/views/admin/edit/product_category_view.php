...
<section id="main" class="column" style="min-height: 1000px;">   
    <article class="module width_3_quarter">
        <header><h3 class="tabs_involved">Все категории</h3>
                    </header>
                    ...
                    <div class="tab_container">
                            ...
                            <tbody> 
                                    ...
                                    <tr> 
                                    <td><?=$item['id'];?></td> 
                                    <td><a target="_blank" href="<?php echo site_url().'/category/'.$item['id'];?>"><?=$item['title'];?></a></td>  
                                    <td><?=$item['description'];?></td> 
                                    <td><?=($item['visible']==1)?'Нет':'Да';?></td>
                                    <td><a href="<?=base_url();?>admin/edit/edit_<?=$page?>/<?=$item['id'];?>"><input type="image" src="/images/icons/icn_edit.png" title="Редактировать"></a><a href="<?=base_url();?>admin/del/<?=$page?>/<?=$item['id'];?>"><input type="image" name="del" src="/images/icons/icn_trash.png" title="Удалить"></a></td> 
                                    </tr> 
                                    <?php endforeach;?>
                            </tbody> 
                            </table>
