...
<article class="module width_full">
    <form method="post" action="<?=base_url();?>index.php/admin/add/product_category" enctype="multipart/form-data">
			<header><h3 style="text-align: center;">Добавить новую категорию товара</h3></header>
				<div class="module_content">
						...
						<fieldset>
							...
							<textarea name="description" rows="12"><?=set_value('description');?></textarea>
